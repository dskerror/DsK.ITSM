...
namespace DsK.ITSM.Services
{
    ...
    {
        public async Task<ServiceResult<TokenModel>> UserLogin(UserLoginDto model)
        {
            ServiceResult<TokenModel> result = new ServiceResult<TokenModel>();
        ...
        public async Task<ServiceResult<UserTokenDto>> RefreshToken(TokenModel model)
        {
            ServiceResult<UserTokenDto> result = new ServiceResult<UserTokenDto>();
