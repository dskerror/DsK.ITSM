...
namespace DsK.ITSM.Pages
{
    public partial class Users
    {
        ...
        public Users(IOptions<TokenSettingsModel> tokenSettings, DsKitsmContext db)
        {
            _tokenSettings = tokenSettings.Value;
            this.db = db;
        }

        //public async Task<ServiceResult<UserDto>> UserCreate(UserCreateDto model)
        //{
        ...
        //    return result;
        //}
        //public async Task<ServiceResult<List<UserDto>>> UsersGet(int id, int pageNumber, int pageSize, string searchString, string orderBy)
        //{
        ...
        //    return result;
        //}
        //public async Task<ServiceResult<string>> UserUpdate(UserDto model)
        //{
        ...
        //    return result;
        //}
        //public async Task<ServiceResult<string>> UserDelete(int id)
        //{
        //    ServiceResult<string> result = new ServiceResult<string>();
        ...
        //}
        public async Task<User> GetUserByMappedUsernameAsync(string username, int AuthenticationProviderId)
        {
